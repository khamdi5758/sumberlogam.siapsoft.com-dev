...
<template>
  ...
  <Transition name="slide">
    ...
    >
      ...
      >
        <h2 class="text-xl font-bold text-main-text">Area Detail</h2>
      ...
      <div class="flex-1 overflow-y-auto p-6 space-y-6">
        <div class="border border-outline rounded-lg p-4 space-y-4">
          <h3 class="text-sm font-semibold text-main-text">Area Info</h3>
        ...
        <div class="border border-outline rounded-lg p-4">
          <div class="flex items-center gap-2 mb-3">
            ...
            <h3 class="text-sm font-semibold text-main-text">Users In Area</h3>
          </div>
