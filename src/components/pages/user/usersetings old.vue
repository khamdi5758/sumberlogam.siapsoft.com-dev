...
<template>
  <!-- Document List -->
  <div
    class="bg-white rounded-lg shadow-sm border border-outline flex flex-col min-h-0 h-screen"
  >
    <div class="p-4 border-b border-outline sticky top-0 z-10 bg-white">
    ...
    <div
      class="px-6 py-4 flex items-center border-b border-outline sticky top-16 z-10 bg-white"
    >
      <!-- KIRI -->
