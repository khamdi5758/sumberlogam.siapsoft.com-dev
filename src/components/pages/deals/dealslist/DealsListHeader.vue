...
<template>
  <div class="pt-3 pb-2 px-4">
    ...
    <div class="flex flex-col gap-3 md:hidden">
      ...
      <div
        class="flex items-center justify-between gap-2 text-xs font-medium text-slate-600"
      >
        <div class="relative">
          <button
          ...
          <div
            v-if="isCurrencyOpen"
            class="absolute left-0 mt-2 w-28 bg-white border border-outline rounded-lg shadow-lg z-20"
          >
            <ul class="py-1">
              <li
        ...
        <div class="relative">
          ...
          <div
            v-if="isPipelineOpen"
            class="absolute right-0 mt-2 w-44 bg-white border border-outline rounded-lg shadow-lg z-20"
          >
            <ul class="py-1">
              <li
