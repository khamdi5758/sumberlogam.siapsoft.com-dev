<template>
  ...
  >
    <div class="flex min-w-0 items-baseline gap-3">
      ...
      <span class="hidden text-sm md:inline" :class="contactsStatusClass">{{
        contactsStatusText
      }}</span>
    </div>
    ...
    <div class="relative md:hidden" ref="mobileActionsRef">
      ...
      >
        ...
        <button
          @click="runMobileAction('connect-facebook')"
          class="flex w-full items-center gap-2 px-4 py-3 text-left text-sm text-facebook hover:bg-gray-100"
        >
          <Facebook :size="16" />
