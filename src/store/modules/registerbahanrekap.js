  ...
  async getRegister({ commit }, requestPayload) {
    ...
    try {
      const payloadApi = {
        ...
        isserial: requestPayload.isserial ?? 0,
        kodejob: requestPayload.kodejob || "",
      };

      const response = await api.post("register/registerbahanrekap", payloadApi);
      ...
      console.error("Error getRegister Bahan Rekap:", error);
    } finally {
